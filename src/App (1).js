...
async function doPDF(m) {
  ...
  if (m.tekijaTunnit) {
    ...
    Object.entries(norm).forEach(([tekija,rivit])=>{
      ...
      row(`${tekija} (${sumTekija(rivit)}h yht.)`, detail);
    });
  }
...
export default function App() {
  ...
  return (
    <div style={R.root}>
      <div style={R.header}>
        <div style={R.htop}>
          <div><div style={R.logo}>⚙ FANTUZZI FIN</div><div style={R.sub}>Työmääräinjärjestelmä</div></div>
    ...
    <div style={R.root}>
      ...
      <div style={R.body}>
        ...
        {Object.keys(norm).length>0&&(
          <>
            <div style={R.lbl}>AIEMMAT TUNNIT</div>
            <div style={{...R.tbox,marginBottom:16}}>
              ...
              <div style={{display:"flex",justifyContent:"space-between",borderTop:"1px solid #e5e7eb",paddingTop:8,marginTop:4}}>
                ...
                <span style={{fontWeight:700,color:"#d97706"}}>{sumH(w)} h</span>
              </div>
            </div>
          </>
        )}
        ...
        <Label>MITÄ TEHTY *</Label>
        <textarea style={{...R.input,height:80,resize:"none"}}
          value={kuvaus} onChange={e=>setKuvaus(e.target.value)}/>
